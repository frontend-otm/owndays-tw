...
(!(function (t, e, n, o) {
  ...
  if (n) {
    ...
    var a = {
        ...
        iframe: {
          tpl: '<iframe id="fancybox-frame{rnd}" name="fancybox-frame{rnd}" class="fancybox-iframe" frameborder="0" vspace="0" hspace="0" webkitAllowFullScreen mozallowfullscreen allow="autoplay; fullscreen" allowtransparency="true" src=""></iframe>',
          preload: !0,
          css: {},
          attr: { scrolling: "auto" },
        },
...
jQuery(function ($) {
  var position =
    $(
      ".l-gundam__project1, .l-gundam__character, .l-gundam__concept, .l-gundam__guide",
    ).offset().top + -40;
...
$(function () {
  $(".gundam-thumbnail li").click(function () {
    var index = $(".gundam-thumbnail li").index(this);
    $(".gundam-thumbnail li").removeClass("is-active");
    $(this).addClass("is-active");
    $(".gundam-view div")
      .removeClass("is-tab-show")
      .eq(index)
      .addClass("is-tab-show");
  });

  $(".char-zaku-thumbnail li").click(function () {
    var index = $(".char-zaku-thumbnail li").index(this);
    console.log("indexindex-----", index);
    $(".char-zaku-thumbnail li").removeClass("is-active");
    $(this).addClass("is-active");
    $(".char-zaku-view div")
      .removeClass("is-tab-show")
      .eq(index)
  ...
  $(".zaku-thumbnail li").click(function () {
    var index = $(".zaku-thumbnail li").index(this);
    $(".zaku-thumbnail li").removeClass("is-active");
    $(this).addClass("is-active");
    $(".zaku-view div")
      .removeClass("is-tab-show")
      .eq(index)
  ...
  $(".dom-thumbnail li").click(function () {
    var index = $(".dom-thumbnail li").index(this);
    $(".dom-thumbnail li").removeClass("is-active");
    $(this).addClass("is-active");
    $(".dom-view div")
      .removeClass("is-tab-show")
      .eq(index)
  ...
  $(".l-gundam__concept-slider").slick({
    autoplaySpeed: 7000,
    speed: 800,
    dots: true,
    arrows: true,
...
$(function () {
  $(window).scroll(function (e) {
    var bottomY = 1,
      ...
      footerHeight = $(".l-footer").height() + 10;
    bottomHeight = footerHeight + height + scrollTop + bottomY - documentHeight;
    if (scrollTop >= documentHeight - height - footerHeight + bottomY) {
      $(".fix-banner").css({ bottom: bottomHeight - bottomY });
    } else {
      $(".fix-banner").css({ bottom: bottomY });
    }
  });
});
...
$(function () {
  $(
    ".iziModal_01, .iziModal_02, .iziModal_03, .iziModal_04, .iziModal_05, .iziModal_06, .iziModal_07, .iziModal_08, .iziModal_09, .iziModal_10",
  ).iziModal({
    group: "production",
    loop: false,
...
$(function () {
  if (window.matchMedia("(max-width: 767px)").matches) {
    $(window).scroll(function () {
      ...
      if (top > 1 && top < 199) {
        $(".is-slide span").removeClass().addClass("slide-lens-1");
      }
      if (top > 200 && top < 299) {
        $(".is-slide span").removeClass().addClass("slide-lens-2");
      }
      if (top > 300 && top < 399) {
        $(".is-slide span").removeClass().addClass("slide-lens-3");
      }
      if (top > 400 && top < 450) {
        $(".is-slide span").removeClass().addClass("slide-lens-4");
      }
    });
